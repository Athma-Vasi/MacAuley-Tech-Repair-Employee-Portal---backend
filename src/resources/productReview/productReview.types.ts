...
import type { GetQueriedResourceRequest, GetQueriedResourceByUserRequest } from '../../types';
...
// DEV ROUTE
interface UpdateProductReviewsFieldsBulkRequest extends RequestAfterJWTVerification {
  body: {
    userInfo: {
      userId: Types.ObjectId;
      username: string;
