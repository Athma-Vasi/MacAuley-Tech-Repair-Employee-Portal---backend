...
const createAccessoryJoiSchema = Joi.object({
  ...
  accessoryType: Joi.string().regex(ACCESSORY_TYPE_REGEX).required(),
  accessoryColor: Joi.string().regex(COLOR_VARIANT_REGEX).required(),
  accessoryInterface: Joi.string().regex(PERIPHERALS_INTERFACE_REGEX).required(),
...
const updateAccessoryJoiSchema = Joi.object({
  ...
  accessoryType: Joi.string().regex(ACCESSORY_TYPE_REGEX),
  accessoryColor: Joi.string().regex(COLOR_VARIANT_REGEX),
  accessoryInterface: Joi.string().regex(PERIPHERALS_INTERFACE_REGEX),
...
export { createAccessoryJoiSchema, updateAccessoryJoiSchema };
