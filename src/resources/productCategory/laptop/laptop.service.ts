...
async function createNewLaptopService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("createNewLaptopService");
  }
}
...
async function getQueriedLaptopsService({
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getQueriedLaptopsService");
  }
}
...
async function getQueriedTotalLaptopsService({
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getQueriedTotalLaptopsService");
  }
}
...
async function getLaptopByIdService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getLaptopByIdService");
  }
}
...
async function updateLaptopByIdService({
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("updateLaptopByIdService");
  }
}
...
async function deleteAllLaptopsService(): Promise<DeleteResult> {
  try {
    ...
    throw new createHttpError.InternalServerError("deleteAllLaptopsService");
  }
}
...
async function deleteALaptopService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("deleteALaptopService");
  }
}
