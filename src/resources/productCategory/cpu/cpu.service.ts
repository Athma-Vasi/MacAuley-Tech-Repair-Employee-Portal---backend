...
async function createNewCpuService(cpuSchema: CpuSchema): Promise<CpuDocument> {
  try {
    ...
    throw new createHttpError.InternalServerError("createNewCpuService");
  }
}
...
async function getQueriedCpusService({
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getQueriedCpusService");
  }
}
...
async function getQueriedTotalCpusService({
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getQueriedTotalCpusService");
  }
}
...
async function getCpuByIdService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getCpuByIdService");
  }
}
...
async function updateCpuByIdService({
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("updateCpuByIdService");
  }
}
...
async function deleteAllCpusService(): Promise<DeleteResult> {
  try {
    ...
    throw new createHttpError.InternalServerError("deleteAllCpusService");
  }
}

async function returnAllCpusUploadedFileIdsService(): Promise<Types.ObjectId[]> {
  try {
...
async function deleteACpuService(cpuId: Types.ObjectId | string): Promise<DeleteResult> {
  try {
    ...
    throw new createHttpError.InternalServerError("deleteACpuService");
  }
}
