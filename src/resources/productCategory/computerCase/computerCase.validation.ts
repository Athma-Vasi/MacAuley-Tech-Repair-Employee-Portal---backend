...
const createComputerCaseJoiSchema = Joi.object({
  ...
  caseSidePanel: Joi.string().regex(CASE_SIDE_PANEL_REGEX).required(),
...
const updateComputerCaseJoiSchema = Joi.object({
  ...
  caseType: Joi.string().regex(CASE_TYPE_REGEX),
  caseColor: Joi.string().regex(COLOR_VARIANT_REGEX),
  caseSidePanel: Joi.string().regex(CASE_SIDE_PANEL_REGEX),
...
export { createComputerCaseJoiSchema, updateComputerCaseJoiSchema };
