...
async function createNewHeadphoneService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("createNewHeadphoneService");
  }
}
...
async function getQueriedHeadphonesService({
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getQueriedHeadphonesService");
  }
}
...
async function getQueriedTotalHeadphonesService({
  ...
  try {
    const totalHeadphones = await HeadphoneModel.countDocuments(filter).lean().exec();
    return totalHeadphones;
  } catch (error: any) {
    throw new createHttpError.InternalServerError("getQueriedTotalHeadphonesService");
  }
}
...
async function getHeadphoneByIdService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getHeadphoneByIdService");
  }
}
...
async function updateHeadphoneByIdService({
  ...
  try {
    const headphone = await HeadphoneModel.findByIdAndUpdate(_id, updateObject, {
      new: true,
    })
    ...
    throw new createHttpError.InternalServerError("updateHeadphoneByIdService");
  }
}
...
async function deleteAllHeadphonesService(): Promise<DeleteResult> {
  try {
    ...
    throw new createHttpError.InternalServerError("deleteAllHeadphonesService");
  }
}

async function returnAllHeadphonesUploadedFileIdsService(): Promise<Types.ObjectId[]> {
  try {
...
async function deleteAHeadphoneService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("deleteAHeadphoneService");
  }
}
