...
async function createNewDisplayService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("createNewDisplayService");
  }
}
...
async function getQueriedDisplaysService({
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getQueriedDisplaysService");
  }
}
...
async function getQueriedTotalDisplaysService({
  ...
  try {
    const totalDisplays = await DisplayModel.countDocuments(filter).lean().exec();
    return totalDisplays;
  } catch (error: any) {
    throw new createHttpError.InternalServerError("getQueriedTotalDisplaysService");
  }
}
...
async function getDisplayByIdService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("getDisplayByIdService");
  }
}
...
async function updateDisplayByIdService({
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("updateDisplayByIdService");
  }
}
...
async function deleteAllDisplaysService(): Promise<DeleteResult> {
  try {
    ...
    throw new createHttpError.InternalServerError("deleteAllDisplaysService");
  }
}

async function returnAllDisplaysUploadedFileIdsService(): Promise<Types.ObjectId[]> {
  try {
...
async function deleteADisplayService(
  ...
  try {
    ...
    throw new createHttpError.InternalServerError("deleteADisplayService");
  }
}
