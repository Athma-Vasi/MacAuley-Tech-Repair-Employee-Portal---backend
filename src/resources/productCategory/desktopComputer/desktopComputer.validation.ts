...
const updateDesktopComputerJoiSchema = Joi.object({
  ...
  motherboardFormFactor: Joi.string().regex(MOTHERBOARD_FORM_FACTOR_REGEX).optional(),
  ...
  speakerFrequencyResponse: Joi.string().regex(FREQUENCY_RESPONSE_REGEX).optional(),
