...
const createMouseJoiSchema = Joi.object({
  ...
  mouseButtons: Joi.number().required(),
  mouseColor: Joi.string().regex(COLOR_VARIANT_REGEX).required(),
  mouseInterface: Joi.string().regex(PERIPHERALS_INTERFACE_REGEX).required(),
...
const updateMouseJoiSchema = Joi.object({
  ...
  mouseSensor: Joi.string().regex(MOUSE_SENSOR_REGEX),
  mouseDpi: Joi.number(),
  mouseButtons: Joi.number(),
  mouseColor: Joi.string().regex(COLOR_VARIANT_REGEX),
  mouseInterface: Joi.string().regex(PERIPHERALS_INTERFACE_REGEX),
...
export { createMouseJoiSchema, updateMouseJoiSchema };
