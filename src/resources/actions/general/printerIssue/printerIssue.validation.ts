...
const createPrinterIssueJoiSchema = Joi.object({
  ...
  printerSerialNumber: Joi.string().regex(PRINTER_SERIAL_NUMBER_REGEX).required(),
  printerIssueDescription: Joi.string().regex(GRAMMAR_TEXTAREA_INPUT_REGEX).required(),
