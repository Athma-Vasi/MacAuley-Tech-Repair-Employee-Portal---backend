...
motherboardRouter
  .route('/')
  .get(assignQueryDefaults(FIND_QUERY_OPTIONS_KEYWORDS), getQueriedMotherboardsHandler)
...
motherboardRouter.route('/fileUploads').post(returnAllFileUploadsForMotherboardsHandler);
