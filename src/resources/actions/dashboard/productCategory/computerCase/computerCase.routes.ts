...
computerCaseRouter
  .route('/')
  .get(assignQueryDefaults(FIND_QUERY_OPTIONS_KEYWORDS), getQueriedComputerCasesHandler)
...
computerCaseRouter.route('/fileUploads').post(returnAllFileUploadsForComputerCasesHandler);
