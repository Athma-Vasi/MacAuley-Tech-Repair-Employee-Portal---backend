...
keyboardRouter
  .route('/')
  .get(assignQueryDefaults(FIND_QUERY_OPTIONS_KEYWORDS), getQueriedKeyboardsHandler)
...
keyboardRouter.route('/fileUploads').post(returnAllFileUploadsForKeyboardsHandler);
