...
storageRouter
  .route('/')
  .get(assignQueryDefaults(FIND_QUERY_OPTIONS_KEYWORDS), getQueriedStoragesHandler)
...
storageRouter.route('/fileUploads').post(returnAllFileUploadsForStoragesHandler);
